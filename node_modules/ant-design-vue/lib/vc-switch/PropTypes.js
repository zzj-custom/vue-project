...
exports.switchPropTypes = void 0;
...
var switchPropTypes = {
  ...
  defaultChecked: _vueTypes.default.bool.def(false),
  autofocus: _vueTypes.default.bool.def(false),
  loadingIcon: _vueTypes.default.any
};
exports.switchPropTypes = switchPropTypes;