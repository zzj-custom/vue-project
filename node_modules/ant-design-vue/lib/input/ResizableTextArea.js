...
var ResizableTextArea = {
  ...
  methods: {
    ...
    renderTextArea: function renderTextArea() {
      ...
      var style = _objectSpread(_objectSpread(_objectSpread({}, props.style), textareaStyles), resizeStatus === RESIZE_STATUS_RESIZING ? {
        overflowX: 'hidden',
        overflowY: 'hidden'
      } : null);

      var textareaProps = _objectSpread(_objectSpread({}, otherProps), {}, {
        style: style,
        class: cls
      });
      ...
      return (0, _vue.createVNode)(_vcResizeObserver.default, {
        ...
        default: function _default() {
          return [(0, _vue.withDirectives)((0, _vue.createVNode)("textarea", (0, _vue.mergeProps)(textareaProps, {
