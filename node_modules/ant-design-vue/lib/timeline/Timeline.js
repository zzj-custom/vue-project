...
var TimelineProps = {
  ...
  mode: _vueTypes.default.oneOf(['left', 'alternate', 'right', ''])
};
...
var _default2 = {
  ...
  render: function render() {
    ...
    var children = (0, _propsUtil.filterEmpty)(this.$slots.default && this.$slots.default()); // // Remove falsy items
    ...
    return (0, _vue.createVNode)("ul", timelineProps, [items]);
  }
};
