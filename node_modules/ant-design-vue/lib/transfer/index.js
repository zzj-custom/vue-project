...
exports.default = exports.TransferLocale = exports.TransferProps = exports.TransferItem = exports.TransferDirection = void 0;
...
var TransferItem = {
  key: _vueTypes.default.string.isRequired,
  title: _vueTypes.default.string.isRequired,
...
var TransferProps = {
  ...
  disabled: _vueTypes.default.boolean,
  ...
  lazy: _vueTypes.default.oneOfType([_vueTypes.default.object, _vueTypes.default.bool]),
  showSelectAll: _vueTypes.default.bool,
...
var TransferLocale = {
  titles: _vueTypes.default.arrayOf(_vueTypes.default.string),
  notFoundContent: _vueTypes.default.string,
  itemUnit: _vueTypes.default.string,
  itemsUnit: _vueTypes.default.string
};
exports.TransferLocale = TransferLocale;
var Transfer = {
  name: 'ATransfer',
  inheritAttrs: false,
  ...
  methods: {
    ...
    getLocale: function getLocale(transferLocale, renderEmpty) {
      ...
      return _objectSpread(_objectSpread(_objectSpread({}, transferLocale), oldLocale), this.$props.locale);
    },
    ...
    renderTransfer: function renderTransfer(transferLocale) {
      ...
      var cls = (0, _classNames2.default)(prefixCls, className, (_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-disabled"), disabled), _defineProperty(_classNames, "".concat(prefixCls, "-customize-list"), !!children), _classNames));
