...
var AnchorProps = {
  ...
  affix: _vueTypes.default.bool,
  showInkInFixed: _vueTypes.default.bool,
...
var _default2 = {
  ...
  methods: {
    ...
    updateInk: function updateInk() {
      ...
      var linkNode = (0, _propsUtil.findDOMNode)(this).getElementsByClassName("".concat(_sPrefixCls, "-link-title-active"))[0];
  ...
  render: function render() {
    ...
    return !affix ? anchorContent : (0, _vue.createVNode)(_affix.default, (0, _vue.mergeProps)(this.$attrs, {
      "offsetTop": offsetTop,
      "target": getContainer
    }), {
