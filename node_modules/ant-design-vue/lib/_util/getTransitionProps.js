...
var getTransitionProps = function getTransitionProps(transitionName) {
  ...
  var transitionProps = _objectSpread({
    ...
    onEnter: function onEnter(el, done) {
      transitionName ? (0, _cssAnimation.default)(el, "".concat(transitionName, "-enter"), done) : done();
    },
    onLeave: function onLeave(el, done) {
      transitionName ? (0, _cssAnimation.default)(el, "".concat(transitionName, "-leave"), done) : done();
    }
  }, opt);
...
var _default = getTransitionProps;
