...
var VuePropTypes = {
  ...
  custom: function custom(validatorFn) {
    ...
    return (0, _utils.toType)(validatorFn.name || '<<anonymous function>>', {
      validator: function validator() {
        ...
        if (!valid) (0, _utils.warn)("".concat(this._vueTypes_name, " - ").concat(warnMsg));
        return valid;
      }
    });
  },
  ...
  oneOfType: function oneOfType(arr) {
    ...
    return this.custom(function oneOfType(value) {
      ...
      if (!valid) (0, _utils.warn)("oneOfType - value type should be one of \"".concat(typesStr, "\""));
      return valid;
    }).def(undefined);
  },
  arrayOf: function arrayOf(type) {
    return (0, _utils.toType)('arrayOf', {
      ...
      validator: function validator(values) {
        ...
        if (!valid) (0, _utils.warn)("arrayOf - value must be an array of \"".concat((0, _utils.getType)(type), "\""));
        return valid;
      }
    });
  },
  objectOf: function objectOf(type) {
    return (0, _utils.toType)('objectOf', {
      ...
      validator: function validator(obj) {
        ...
        if (!valid) (0, _utils.warn)("objectOf - value must be an object of \"".concat((0, _utils.getType)(type), "\""));
        return valid;
      }
    });
  },
    ...
    var type = (0, _utils.toType)('shape', {
      ...
      validator: function validator(value) {
        ...
        if (requiredKeys.length > 0 && requiredKeys.some(function (req) {
          ...
          (0, _utils.warn)("shape - at least one of required properties \"".concat(requiredKeys.join('", "'), "\" is not present"));
          return false;
        }
        ...
        return valueKeys.every(function (key) {
          if (keys.indexOf(key) === -1) {
            ...
            (0, _utils.warn)("shape - object is missing \"".concat(key, "\" property"));
            return false;
          }
