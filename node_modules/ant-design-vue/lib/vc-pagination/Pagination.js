...
var _default = {
  ...
  props: {
    ...
    hideOnSinglePage: _vueTypes.default.bool.def(false),
    showSizeChanger: _vueTypes.default.bool.def(false),
    showLessItems: _vueTypes.default.bool.def(false),
    // showSizeChange: PropTypes.func.def(noop),
    selectComponentClass: _vueTypes.default.any,
    showPrevNextJumpers: _vueTypes.default.bool.def(true),
    showQuickJumper: _vueTypes.default.oneOfType([_vueTypes.default.bool, _vueTypes.default.object]).def(false),
    showTitle: _vueTypes.default.bool.def(true),
  ...
  render: function render() {
    ...
    var _splitAttrs$extraAttr = (0, _propsUtil.splitAttrs)(this.$attrs).extraAttrs,
        ...
        restAttrs = _objectWithoutProperties(_splitAttrs$extraAttr, ["class"]); // When hideOnSinglePage is true and there is only 1 page, hide the pager
    ...
    if (this.simple) {
      ...
      return (0, _vue.createVNode)("ul", (0, _vue.mergeProps)({
    ...
    if (allPages <= 5 + pageBufferSize * 2) {
      ...
      if (!allPages) {
        pagerList.push((0, _vue.createVNode)(_Pager.default, (0, _vue.mergeProps)(pagerProps, {
          "key": "noPager",
          "page": allPages,
