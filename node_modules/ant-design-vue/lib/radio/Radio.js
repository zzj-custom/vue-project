...
var _default = {
  ...
  render: function render() {
    ...
    var wrapperClassString = (0, _classNames2.default)((_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-wrapper"), true), _defineProperty(_classNames, "".concat(prefixCls, "-wrapper-checked"), radioProps.checked), _defineProperty(_classNames, "".concat(prefixCls, "-wrapper-disabled"), radioProps.disabled), _classNames));
    return (0, _vue.createVNode)("label", {
      "class": wrapperClassString
    }, [(0, _vue.createVNode)(_vcCheckbox.default, (0, _vue.mergeProps)(radioProps, {
      "ref": "vcCheckbox"
