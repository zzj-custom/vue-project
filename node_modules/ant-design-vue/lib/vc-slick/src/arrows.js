...
var PrevArrow = function PrevArrow(_, _ref) {
  ...
  if (attrs.prevArrow) {
    prevArrow = (0, _vnode.cloneElement)(attrs.prevArrow(_objectSpread(_objectSpread({}, prevArrowProps), customProps)), {
      key: '0',
      class: prevClasses,
      style: {
        display: 'block'
    ...
    prevArrow = (0, _vue.createVNode)("button", (0, _vue.mergeProps)({
      "key": "0",
      "type": "button"
...
var NextArrow = function NextArrow(_, _ref2) {
  ...
  if (attrs.nextArrow) {
    nextArrow = (0, _vnode.cloneElement)(attrs.nextArrow(_objectSpread(_objectSpread({}, nextArrowProps), customProps)), {
      key: '1',
      class: (0, _classNames.default)(nextClasses),
      style: {
        display: 'block'
    ...
    nextArrow = (0, _vue.createVNode)("button", (0, _vue.mergeProps)({
      "key": "1",
      "type": "button"
