...
var TreeNode = {
  ...
  props: (0, _propsUtil.initDefaultProps)({
    ...
    // By parent
    expanded: _vueTypes.default.bool,
    selected: _vueTypes.default.bool,
    checked: _vueTypes.default.bool,
    loaded: _vueTypes.default.bool,
    loading: _vueTypes.default.bool,
    halfChecked: _vueTypes.default.bool,
    title: _vueTypes.default.any,
    pos: _vueTypes.default.string,
    dragOver: _vueTypes.default.bool,
    dragOverGapTop: _vueTypes.default.bool,
    dragOverGapBottom: _vueTypes.default.bool,
    // By user
    isLeaf: _vueTypes.default.bool,
    checkable: _vueTypes.default.bool,
    selectable: _vueTypes.default.bool,
    disabled: _vueTypes.default.bool,
    disableCheckbox: _vueTypes.default.bool,
  ...
  methods: {
    ...
    renderSwitcher: function renderSwitcher() {
      ...
      if (this.isLeaf2()) {
        ...
        }, [typeof switcherIcon === 'function' ? switcherIcon(_objectSpread(_objectSpread(_objectSpread({}, this.$props), this.$props.dataRef), {}, {
          isLeaf: true
        })) : switcherIcon]);
      }
    ...
    renderSelector: function renderSelector() {
      ...
      if (showIcon) {
        ...
        }, [typeof currentIcon === 'function' ? currentIcon(_objectSpread(_objectSpread({}, this.$props), this.$props.dataRef)) : currentIcon]) : this.renderIcon();
      ...
      }, [typeof currentTitle === 'function' ? currentTitle(_objectSpread(_objectSpread({}, this.$props), this.$props.dataRef)) : currentTitle]) : (0, _vue.createVNode)("span", {
        "class": "".concat(prefixCls, "-title")
      }, [defaultTitle]);
      return (0, _vue.createVNode)("span", {
        "key": "selector",
    ...
    renderChildren: function renderChildren() {
      ...
      if (openTransitionName) {
        animProps = (0, _getTransitionProps.default)(openTransitionName);
      } else if (_typeof(openAnimation) === 'object') {
        animProps = _objectSpread(_objectSpread({}, openAnimation), {}, {
          css: false
        }, animProps);
      } // Children TreeNode
      ...
      return (0, _vue.createVNode)(_vue.Transition, animProps, {
  ...
  render: function render() {
    ...
    var disabled = this.isDisabled();
    var dataOrAriaAttributeProps = (0, _util.getDataAndAria)(_objectSpread(_objectSpread({}, this.$props), this.$attrs));
