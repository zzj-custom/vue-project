...
var Tree = {
  ...
  props: (0, _propsUtil.initDefaultProps)({
    ...
    showLine: _vueTypes.default.bool,
    showIcon: _vueTypes.default.bool,
    ...
    checkable: _vueTypes.default.oneOfType([_vueTypes.default.object, _vueTypes.default.bool]),
    checkStrictly: _vueTypes.default.bool,
    draggable: _vueTypes.default.bool,
    defaultExpandParent: _vueTypes.default.bool,
    autoExpandParent: _vueTypes.default.bool,
    defaultExpandAll: _vueTypes.default.bool,
  ...
  data: function data() {
    ...
    return _objectSpread(_objectSpread({}, state), this.getDerivedState((0, _propsUtil.getOptionProps)(this), state));
  },
  ...
  watch: _objectSpread(_objectSpread({}, getWatch(['treeData', 'children', 'expandedKeys', 'autoExpandParent', 'selectedKeys', 'checkedKeys', 'loadedKeys'])), {}, {
  ...
  render: function render() {
    ...
    var domProps = (0, _util.getDataAndAria)(_objectSpread(_objectSpread({}, this.$props), this.$attrs));
    var _this$$attrs = this.$attrs,
        className = _this$$attrs.class,
        style = _this$$attrs.style;
    return (0, _vue.createVNode)("ul", (0, _vue.mergeProps)(domProps, {
      "class": (0, _classNames2.default)(prefixCls, className, _defineProperty({}, "".concat(prefixCls, "-show-line"), showLine)),
      "style": style,
      "role": "tree",
      "unselectable": "on",
