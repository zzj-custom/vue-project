...
var _default2 = {
  ...
  setup: function setup(nextProps) {
    ...
    var state = (0, _vue.reactive)({
      ...
      sValueKeys: (0, _util.generateValueMaps)(column.filters)
    });
    (0, _vue.watchEffect)(function () {
      var column = nextProps.column;

      if (!(0, _shallowequal.default)(preProps.selectedKeys, nextProps.selectedKeys)) {
        state.sSelectedKeys = nextProps.selectedKeys;
      }

      if (!(0, _shallowequal.default)((preProps.column || {}).filters, (nextProps.column || {}).filters)) {
        state.sValueKeys = (0, _util.generateValueMaps)(nextProps.column.filters);
      }
    ...
    renderFilterIcon: function renderFilterIcon() {
      ...
      if (filterIcon.length === 1 && (0, _propsUtil.isValidElement)(filterIcon[0])) {
        ...
        return (0, _vnode.cloneElement)(filterIcon[0], {
          ...
          onClick: stopPropagation,
          class: (0, _classNames4.default)("".concat(prefixCls, "-icon"), dropdownIconClass, (_filterIcon$props2 = filterIcon.props) === null || _filterIcon$props2 === void 0 ? void 0 : _filterIcon$props2.class)
        });
      }
