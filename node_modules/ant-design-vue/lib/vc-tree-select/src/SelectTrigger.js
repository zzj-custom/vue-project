...
var SelectTrigger = {
  ...
  render: function render() {
    ...
    return (0, _vue.createVNode)(_vcTrigger.default, {
      ...
      "stretch": stretch,
      "popupClassName": (0, _classNames2.default)(dropdownClassName, (_classNames = {}, _defineProperty(_classNames, "".concat(dropdownPrefixCls, "--multiple"), isMultiple), _defineProperty(_classNames, "".concat(dropdownPrefixCls, "--single"), !isMultiple), _classNames)),
