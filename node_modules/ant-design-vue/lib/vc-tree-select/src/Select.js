...
var Select = {
  ...
  props: (0, _propsUtil.initDefaultProps)({
    ...
    maxTagPlaceholder: _vueTypes.default.oneOfType([_vueTypes.default.any, _vueTypes.default.func]),
    ...
    treeDataSimpleMode: _vueTypes.default.oneOfType([_vueTypes.default.bool, _vueTypes.default.object]),
    treeNodeFilterProp: _vueTypes.default.string,
    treeNodeLabelProp: _vueTypes.default.string,
    treeCheckable: _vueTypes.default.oneOfType([_vueTypes.default.any, _vueTypes.default.object, _vueTypes.default.bool]),
    // treeCheckable: PropTypes.any,
    treeCheckStrictly: _vueTypes.default.bool,
    treeIcon: _vueTypes.default.bool,
    treeLine: _vueTypes.default.bool,
    ...
    filterTreeNode: _vueTypes.default.oneOfType([_vueTypes.default.func, _vueTypes.default.bool]),
  ...
  watch: _objectSpread(_objectSpread({}, getWatch(['treeData', 'defaultValue', 'value'])), {}, {
  ...
  methods: {
    getDerivedState: function getDerivedState(nextProps, prevState) {
      ...
      var newState = {
        _prevProps: _objectSpread({}, nextProps),
        _init: false
      };
  ...
  render: function render() {
    ...
    var passProps = _objectSpread(_objectSpread(_objectSpread({}, props), this.$attrs), {}, {
    ...
    var popupProps = _objectSpread(_objectSpread({}, passProps), {}, {
      treeNodes: treeNodes,
    ...
    var $popup = (0, _vue.createVNode)(Popup, (0, _vue.mergeProps)(popupProps, {
      "__propsSymbol__": []
    }), null);
    var Selector = isMultiple ? _MultipleSelector.default : _SingleSelector.default;
    var $selector = (0, _vue.createVNode)(Selector, (0, _vue.mergeProps)(passProps, {
      "ref": this.selectorRef
    }), null);

    var selectTriggerProps = _objectSpread(_objectSpread({}, passProps), {}, {
      popupElement: $popup,
