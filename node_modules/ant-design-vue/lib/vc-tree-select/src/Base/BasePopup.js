...
var BasePopup = {
  ...
  data: function data() {
    ...
    return _objectSpread(_objectSpread({}, state), getDerivedState(this.$props, state));
  },
  methods: {
  ...
  render: function render() {
    ...
    if ($notFound) {
      ...
      var treeAllProps = _objectSpread(_objectSpread({
      ...
      $tree = (0, _vue.createVNode)(_vcTree.default, (0, _vue.mergeProps)(treeAllProps, {
        "ref": this.treeRef,
        "__propsSymbol__": []
      }), null);
    }
