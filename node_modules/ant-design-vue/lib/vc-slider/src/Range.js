...
var rangeProps = {
  ...
  pushable: _vueTypes.default.oneOfType([_vueTypes.default.bool, _vueTypes.default.number]),
  allowCross: _vueTypes.default.bool,
  disabled: _vueTypes.default.bool,
  reverse: _vueTypes.default.bool,
  ...
  methods: {
    ...
    getTrack: function getTrack(_ref3) {
      ...
      return bounds.slice(0, -1).map(function (_, index) {
        ...
        var i = index + 1;
        var trackClassName = (0, _classNames3.default)((_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-track"), true), _defineProperty(_classNames, "".concat(prefixCls, "-track-").concat(i), true), _classNames));
    ...
    renderSlider: function renderSlider() {
      ...
      var handles = bounds.map(function (v, i) {
        ...
        return handleGenerator({
          class: (0, _classNames3.default)((_classNames2 = {}, _defineProperty(_classNames2, handleClassName, true), _defineProperty(_classNames2, "".concat(handleClassName, "-").concat(i + 1), true), _classNames2)),
          prefixCls: prefixCls,
          vertical: vertical,
          offset: offsets[i],
          value: v,
