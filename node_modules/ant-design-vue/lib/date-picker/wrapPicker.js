  ...
  return {
    ...
    methods: {
      ...
      getDefaultLocale: function getDefaultLocale() {
        var result = _objectSpread(_objectSpread({}, _en_US.default), this.locale);
      ...
      renderPicker: function renderPicker(locale, localeCode) {
        ...
        var vcTimePickerProps = _objectSpread(_objectSpread({}, (0, _timePicker.generateShowHourMinuteSecond)(timeFormat)), {}, {
          format: timeFormat,
