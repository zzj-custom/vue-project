...
var _partition = _interopRequireDefault(require("lodash-es/partition"));
...
var upLoadPropTypes = {
  ...
  directory: _vueTypes.default.bool,
  ...
  openFileDialogOnClick: _vueTypes.default.bool,
...
var AjaxUploader = {
  ...
  render: function render() {
    ...
    var className = $attrs.class,
        style = $attrs.style,
        id = $attrs.id;
    var cls = (0, _classNames2.default)((_classNames = {}, _defineProperty(_classNames, prefixCls, true), _defineProperty(_classNames, "".concat(prefixCls, "-disabled"), disabled), _defineProperty(_classNames, className, className), _classNames));
    var events = disabled ? {} : {
    ...
    var tagProps = _objectSpread(_objectSpread({}, events), {}, {
      role: 'button',
