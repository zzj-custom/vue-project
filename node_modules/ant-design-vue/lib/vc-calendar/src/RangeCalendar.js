...
var RangeCalendar = {
  ...
  props: {
    ...
    showDateInput: _vueTypes.default.bool.def(true),
    timePicker: _vueTypes.default.any,
    showOk: _vueTypes.default.bool,
    showToday: _vueTypes.default.bool.def(true),
    defaultSelectedValue: _vueTypes.default.array.def([]),
    selectedValue: _vueTypes.default.array,
    showClear: _vueTypes.default.bool,
    showWeekNumber: _vueTypes.default.bool,
    ...
    inputReadOnly: _vueTypes.default.bool
  },
  ...
  render: function render() {
    ...
    var baseProps = _objectSpread(_objectSpread({}, props), this.$attrs);
    ...
    var leftPartProps = _objectSpread(_objectSpread(_objectSpread({}, baseProps), newProps), {}, {
    ...
    var rightPartProps = _objectSpread(_objectSpread(_objectSpread({}, baseProps), newProps), {}, {
      hoverValue: sHoverValue,
      direction: 'right',
      format: this.getFormat(),
    ...
    if (showToday) {
      var todayButtonProps = _objectSpread(_objectSpread({}, baseProps), {}, {
      ...
      TodayButtonNode = (0, _vue.createVNode)(_TodayButton.default, (0, _vue.mergeProps)({
        "key": "todayButton"
    ...
    if (props.timePicker) {
      var timePickerButtonProps = _objectSpread(_objectSpread({}, baseProps), {}, {
      ...
      TimePickerButtonNode = (0, _vue.createVNode)(_TimePickerButton.default, (0, _vue.mergeProps)({
    ...
    if (showOkButton) {
      var okButtonProps = _objectSpread(_objectSpread({}, baseProps), {}, {
        okDisabled: !this.isAllowedDateAndTime(sSelectedValue) || !this.hasSelectedValue() || sHoverValue.length,
        onOk: this.onOk
      });

      OkButtonNode = (0, _vue.createVNode)(_OkButton.default, (0, _vue.mergeProps)({
        "key": "okButtonNode"
      }, okButtonProps), null);
    }
