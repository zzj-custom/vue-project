...
var CalendarFooter = {
  ...
  props: {
    ...
    showDateInput: _vueTypes.default.bool,
    ...
    showToday: _vueTypes.default.bool,
    disabledDate: _vueTypes.default.func,
    showTimePicker: _vueTypes.default.bool,
    okDisabled: _vueTypes.default.bool,
  ...
  render: function render() {
    ...
    if (showToday || timePicker || extraFooter) {
      ...
      var btnProps = _objectSpread(_objectSpread(_objectSpread({}, props), this.$attrs), {}, {
        value: value
      });
      ...
      if (showToday) {
        nowEl = (0, _vue.createVNode)(_TodayButton.default, (0, _vue.mergeProps)({
          "key": "todayButton"
        }, btnProps), null);
      }
      ...
      if (showOk === true || showOk !== false && !!timePicker) {
        okBtn = (0, _vue.createVNode)(_OkButton.default, (0, _vue.mergeProps)({
          "key": "okButton"
        }, btnProps), null);
      }
      ...
      if (timePicker) {
        timePickerBtn = (0, _vue.createVNode)(_TimePickerButton.default, (0, _vue.mergeProps)({
