...
exports.default = exports.CalendarProps = exports.CalendarMode = void 0;
...
function isMomentArray(value) {
  return Array.isArray(value) && !!value.find(function (val) {
    return _moment.default.isMoment(val);
  });
}

var CalendarMode = _vueTypes.default.oneOf(['month', 'year']);
...
var CalendarProps = function CalendarProps() {
  return {
    ...
    validRange: _vueTypes.default.custom(isMomentArray),
...
var Calendar = {
  ...
  methods: {
    ...
    getDefaultLocale: function getDefaultLocale() {
      var result = _objectSpread(_objectSpread({}, _en_US.default), this.$props.locale);
    ...
    monthCellRender2: function monthCellRender2(_ref) {
      ...
      return (0, _vue.createVNode)("div", {
        "class": "".concat(_sPrefixCls, "-month")
      }, [(0, _vue.createVNode)("div", {
        "class": "".concat(_sPrefixCls, "-value")
      }, [value.localeData().monthsShort(value)]), (0, _vue.createVNode)("div", {
        "class": "".concat(_sPrefixCls, "-content")
      }, [monthCellRender({
        current: value
      })])]);
    },
    ...
    renderCalendar: function renderCalendar(locale, localeCode) {
      ...
      var fullCalendarProps = _objectSpread(_objectSpread(_objectSpread({}, props), this.$attrs), {}, {
        Select: {},
        locale: locale.lang,
