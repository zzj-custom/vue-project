...
var Select = (_Select = {
...
}, _defineProperty(_Select, "inheritAttrs", false), _defineProperty(_Select, "props", _objectSpread(_objectSpread({}, _PropTypes.SelectPropTypes), {}, {
  prefixCls: _PropTypes.SelectPropTypes.prefixCls.def('rc-select'),
  defaultOpen: _vueTypes.default.bool.def(false),
  ...
  dropdownMatchSelectWidth: _vueTypes.default.bool.def(true),
  dropdownStyle: _PropTypes.SelectPropTypes.dropdownStyle.def(function () {
    return {};
  }),
  dropdownMenuStyle: _vueTypes.default.object.def(function () {
    return {};
  }),
  ...
  notFoundContent: _vueTypes.default.any.def('Not Found'),
  backfill: _vueTypes.default.bool.def(false),
  showAction: _PropTypes.SelectPropTypes.showAction.def(['click']),
  combobox: _vueTypes.default.bool.def(false),
  tokenSeparators: _vueTypes.default.arrayOf(_vueTypes.default.string).def([]),
  autoClearSearchValue: _vueTypes.default.bool.def(true),
  tabindex: _vueTypes.default.any.def(0),
  dropdownRender: _vueTypes.default.func.def(function (_ref) {
  ...
  (0, _warning.default)(this.__propsSymbol__, 'Replace slots.default with props.children and pass props.__propsSymbol__');
  ...
  __propsSymbol__: function __propsSymbol__() {
    _extends(this.$data, this.getDerivedState((0, _propsUtil.getOptionProps)(this), this.$data));
  }
  ...
  getOptionsFromChildren: function getOptionsFromChildren() {
    ...
    children.forEach(function (child) {
      ...
      if ((_child$type = child.type) === null || _child$type === void 0 ? void 0 : _child$type.isSelectOptGroup) {
        _this3.getOptionsFromChildren((0, _propsUtil.getSlot)(child), options);
      } else {
        options.push(child);
      }
    });
  ...
  onKeyDown: function onKeyDown(event) {
    ...
    if (open && !this.getInputDOMNode()) {
      ...
      if (keyCode === _KeyCode.default.ENTER && !(0, _util.isMultipleOrTags)(this.$props)) {
  ...
  onInputKeydown: function onInputKeydown(event) {
    ...
    if ((0, _util.isMultipleOrTags)(this.$props) && !event.target.value && keyCode === _KeyCode.default.BACKSPACE) {
      event.preventDefault();
    ...
    } else if (keyCode === _KeyCode.default.ENTER && state._open) {
  ...
  onMenuDeselect: function onMenuDeselect(_ref3) {
    ...
    if (domEvent.type === 'keydown' && domEvent.keyCode === _KeyCode.default.ENTER) {
      var menuItemDomNode = (0, _propsUtil.findDOMNode)(item); // https://github.com/ant-design/ant-design/issues/20465#issuecomment-569033796
  ...
  getOptionInfoBySingleValue: function getOptionInfoBySingleValue(value, optionsInfo) {
    ...
    var defaultInfo = {
      option: (0, _vue.createVNode)(_Option.default, {
        "value": value,
        "key": value
      }, {
  ...
  getPlaceholderElement: function getPlaceholderElement() {
    ...
    if ((0, _util.isCombobox)(props) && value.length === 1 && state._value && !(0, _isValid.default)(state._value[0])) {
      hidden = false;
    }
    ...
    if (placeholder) {
      ...
      return (0, _vue.createVNode)("div", p, [placeholder]);
    }
  ...
  inputBlur: function inputBlur(e) {
    ...
    if ((_env.isIE || _env.isEdge) && (e.relatedTarget === this.$refs.arrow || target && this.selectTriggerRef && (0, _propsUtil.findDOMNode)(this.selectTriggerRef.getInnerMenu()) === target || (0, _contains.default)(e.target, target))) {
      e.target.focus();
      e.preventDefault();
      return;
    }
  ...
  _getInputElement: function _getInputElement() {
    ...
    var defaultInput = (0, _vue.createVNode)("input", (0, _vue.mergeProps)(attrs.id !== undefined ? {
      id: attrs.id
    } : {}, {
      "autocomplete": "off"
    }), null);
    var inputElement = props.getInputElement ? props.getInputElement() : defaultInput;
    var inputCls = (0, _classNames.default)(inputElement.props && inputElement.props.class, _defineProperty({}, "".concat(props.prefixCls, "-search__field"), true));
    var inputEvents = (0, _propsUtil.getEvents)(inputElement); // https://github.com/ant-design/ant-design/issues/4992#issuecomment-281542159
    // Add space to the end of the inputValue as the width measurement tolerance

    return (0, _vue.createVNode)("div", {
      "class": "".concat(props.prefixCls, "-search__field__wrap"),
      "onClick": this.inputClick
    }, [(0, _vnode.cloneElement)((0, _vue.withDirectives)(inputElement, [[_antInputDirective.default]]), _objectSpread(_objectSpread({
    ...
    }, [inputValue, (0, _vue.createTextVNode)("\xA0")])]);
  },
  ...
  updateFocusClassName: function updateFocusClassName() {
    ...
    if (this._focused) {
      (0, _componentClasses.default)(rootRef).add("".concat(prefixCls, "-focused"));
    } else {
      (0, _componentClasses.default)(rootRef).remove("".concat(prefixCls, "-focused"));
    }
  },
  ...
  fireChange: function fireChange(value) {
    ...
    this.__emit('change', vls, (0, _util.isMultipleOrTags)(this.$props) ? options : options[0]);
  },
  ...
  renderFilterOptions: function renderFilterOptions() {
    ...
    if (tags) {
      ...
      value.forEach(function (singleValue) {
        ...
        var attrs = _objectSpread(_objectSpread({}, _util.UNSELECTABLE_ATTRIBUTE), {}, {
          role: 'option'
        });

        var menuItem = (0, _vue.createVNode)(_vcMenu.Item, (0, _vue.mergeProps)({
      ...
      if (inputValue && menuItems.every(function (option) {
        ...
        var p = _objectSpread(_objectSpread({}, _util.UNSELECTABLE_ATTRIBUTE), {}, {
          key: inputValue,
          value: inputValue,
          role: 'option',
          style: _util.UNSELECTABLE_STYLE
        ...
        options.unshift((0, _vue.createVNode)(_vcMenu.Item, p, {
          default: function _default() {
            return [inputValue];
          }
        }));
    ...
    if (!options.length && notFoundContent) {
      ...
      var _p = _objectSpread(_objectSpread({}, _util.UNSELECTABLE_ATTRIBUTE), {}, {
        key: 'NOT_FOUND',
        value: 'NOT_FOUND',
        disabled: true,
        role: 'option',
      ...
      options = [(0, _vue.createVNode)(_vcMenu.Item, _p, {
        default: function _default() {
  ...
  renderFilterOptionsFromChildren: function renderFilterOptionsFromChildren() {
    ...
    children.forEach(function (child) {
      ...
      if (type === null || type === void 0 ? void 0 : type.isSelectOptGroup) {
        ...
        var childChildren = (0, _propsUtil.getComponent)(child);
        ...
        if (inputValue && _this13._filterOption(inputValue, child)) {
          var innerItems = childChildren.map(function (subChild) {
            ...
            return (0, _vue.createVNode)(_vcMenu.Item, (0, _vue.mergeProps)({
              "key": childValueSub,
              "value": childValueSub
            }, subChild.props), {
              default: function _default() {
                return _toConsumableArray((0, _propsUtil.getSlot)(subChild));
              }
            });
          });
          sel.push((0, _vue.createVNode)(_vcMenu.ItemGroup, {
            "key": key,
            "title": label,
          ...
          if (_innerItems.length) {
            sel.push((0, _vue.createVNode)(_vcMenu.ItemGroup, (0, _vue.mergeProps)({
              "key": key,
              "title": label
            }, child.props), {
              default: function _default() {
      ...
      (0, _warning.default)(_typeof(type) === 'object' && type.isSelectOption, 'the children of `Select` should be `Select.Option` or `Select.OptGroup`, ');
      var childValue = (0, _util.getValuePropValue)(child);
      (0, _util.validateOptionValue)(childValue, _this13.$props);

      if (_this13._filterOption(inputValue, child)) {
        var p = _objectSpread(_objectSpread(_objectSpread({}, _util.UNSELECTABLE_ATTRIBUTE), {}, {
          key: childValue,
          value: childValue
        ...
        var menuItem = (0, _vue.createVNode)(_vcMenu.Item, p, {
          default: function _default() {
            return [(0, _propsUtil.getSlot)(child)];
          }
        });
        sel.push(menuItem);
        menuItems.push(menuItem);
  ...
  renderTopControlNode: function renderTopControlNode() {
    ...
    if ((0, _util.isSingleMode)(props)) {
      ...
      if (value.length) {
        ...
        selectedValue = (0, _vue.createVNode)("div", {
          "key": "value",
      ...
      if (!showSearch) {
        ...
        innerNode = [selectedValue, (0, _vue.createVNode)("div", {
      ...
      if (maxTagCount !== undefined && value.length > maxTagCount) {
        ...
        maxTagPlaceholderEl = (0, _vue.createVNode)("li", (0, _vue.mergeProps)({
          "style": _util.UNSELECTABLE_STYLE
        }, attrs, {
          "onMousedown": _util.preventDefaultEvent,
      ...
      if ((0, _util.isMultipleOrTags)(props)) {
        selectedValueNodes = limitedCountValue.map(function (singleValue) {
          ...
          return (0, _vue.createVNode)("li", (0, _vue.mergeProps)({
            "style": _util.UNSELECTABLE_STYLE
          }, attrs, {
            "onMousedown": _util.preventDefaultEvent,
      ...
      selectedValueNodes.push((0, _vue.createVNode)("li", {
        "class": "".concat(prefixCls, "-search ").concat(prefixCls, "-search--inline"),
        "key": "__input"
      }, [this._getInputElement()]));

      if ((0, _util.isMultipleOrTags)(props) && choiceTransitionName) {
        var transitionProps = (0, _getTransitionProps.default)(choiceTransitionName, {
          tag: 'ul',
          onAfterLeave: this.onChoiceAnimationLeave
        });
        innerNode = (0, _vue.createVNode)(_vue.TransitionGroup, transitionProps, {
          default: function _default() {
            return [selectedValueNodes];
          }
        });
      } else {
        innerNode = (0, _vue.createVNode)("ul", null, [selectedValueNodes]);
      }
    }
  ...
  renderClear: function renderClear() {
    ...
    var clear = (0, _vue.createVNode)("span", (0, _vue.mergeProps)({
      "key": "clear",
  ...
  var rootCls = (_rootCls = {}, _defineProperty(_rootCls, className, className), _defineProperty(_rootCls, prefixCls, true), _defineProperty(_rootCls, "".concat(prefixCls, "-open"), open), _defineProperty(_rootCls, "".concat(prefixCls, "-focused"), open || !!this._focused), _defineProperty(_rootCls, "".concat(prefixCls, "-combobox"), (0, _util.isCombobox)(props)), _defineProperty(_rootCls, "".concat(prefixCls, "-disabled"), disabled), _defineProperty(_rootCls, "".concat(prefixCls, "-enabled"), !disabled), _defineProperty(_rootCls, "".concat(prefixCls, "-allow-clear"), !!props.allowClear), _defineProperty(_rootCls, "".concat(prefixCls, "-no-arrow"), !showArrow), _defineProperty(_rootCls, "".concat(prefixCls, "-loading"), !!loading), _rootCls);
  return (0, _vue.createVNode)(_SelectTrigger.default, {
    ...
    "menuItemSelectedIcon": (0, _propsUtil.getComponent)(this, 'menuItemSelectedIcon'),
    "ref": this.saveSelectTriggerRef,
    "dropdownRender": props.dropdownRender,
    "ariaId": this.$data._ariaId
  }, {
    default: function _default() {
      return [(0, _vue.createVNode)("div", (0, _vue.mergeProps)((0, _util2.getDataAndAriaProps)(_this15.$attrs), {
        "ref": chaining(_this15.saveRootRef, _this15.saveSelectionRef),
        "style": style,
        "class": (0, _classNames.default)(rootCls),
        ...
        "onKeydown": (0, _util.isMultipleOrTagsOrCombobox)(props) ? noop : _this15.onKeyDown
      }), [(0, _vue.createVNode)("div", selectionProps, [_this15.renderTopControlNode(), _this15.renderClear(), _this15.renderArrow(!!multiple)])])];
    }
  });
}), _Select);
