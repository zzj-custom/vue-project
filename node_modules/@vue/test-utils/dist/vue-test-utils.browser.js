...
var VueTestUtils = (function (exports, vue, compilerDom) {
    ...
    ***************************************************************************** */
    ...
    var VueWrapper = /** @class */ (function () {
        function VueWrapper(app, vm, setProps, meta) {
            this.__app = app;
            this.rootVM = vm.$root;
            this.componentVM = vm;
        ...
        VueWrapper.prototype.emitted = function (eventName) {
            if (this.__isFunctionalComponent) {
                console.warn('[Vue Test Utils]: capture events emitted from functional components is currently not supported.');
            }
            if (eventName) {
            ...
            if (typeof selector === 'object' && 'ref' in selector) {
                ...
                if (result_1) {
                    return createWrapper(null, result_1, {
                        isFunctionalComponent: isFunctionalComponent(result_1)
                    });
                }
            }
        ...
        VueWrapper.prototype.findAllComponents = function (selector) {
            return find(this.vm.$.subTree, selector).map(function (c) {
                return createWrapper(null, c, {
    ...
    function createWrapper(app, vm, meta, setProps) {
        return new VueWrapper(app, vm, setProps, meta);
    }
