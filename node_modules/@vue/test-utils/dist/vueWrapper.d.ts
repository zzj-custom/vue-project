...
import { FindAllComponentsSelector, FindComponentSelector, VueWrapperMeta } from './types';
...
export declare class VueWrapper<T extends ComponentPublicInstance> {
    ...
    private __app;
    private __setProps;
    private __isFunctionalComponent;
    constructor(app: App | null, vm: ComponentPublicInstance, setProps?: (props: Record<string, any>) => void, meta?: VueWrapperMeta);
...
export declare function createWrapper<T extends ComponentPublicInstance>(app: App | null, vm: ComponentPublicInstance, meta: VueWrapperMeta, setProps?: (props: Record<string, any>) => void): VueWrapper<T>;
